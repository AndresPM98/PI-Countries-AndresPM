...
const getInfo = async () => {   // Funcion que hace el llamado a la API ...
  try {                         // Utilizamos el "Try/Catch" para manejar un posible error ...
    ...
    apiInfo.map((element) => {      // Mapeamos la info y se usa el método "findOrCreate" en la Tabla...
      Country.findOrCreate({        // "Country" (en la base de datos) para buscar un registro con los valores... 
